from canvasaio.assignment import Assignment, AssignmentGroup
...
from canvasaio.page import Page
from canvasaio.paginated_list import PaginatedList
from canvasaio.progress import Progress
from canvasaio.quiz import QuizExtension
from canvasaio.tab import Tab
from canvasaio.rubric import RubricAssociation, Rubric
...
class Course(CanvasObject):
    ...
    async def create_course_section(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.course.Section`
        """
    ...
    async def create_external_feed(self, url, **kwargs):
        ...
        :type url: str
        :rtype: :class:`canvasaio.external_feed.ExternalFeed`
        """
    ...
    async def create_quiz(self, quiz, **kwargs):
        ...
        """
        from canvasaio.quiz import Quiz
    ...
    async def delete_external_feed(self, feed, **kwargs):
        ...
        :type feed: :class:`canvasaio.external_feed.ExternalFeed` or int
    ...
    def get_all_outcome_links_in_context(self, **kwargs):
        ...
        """
        from canvasaio.outcome import OutcomeLink
    ...
    async def get_assignment_group(self, assignment_group, **kwargs):
        ...
        :type assignment_group: :class:`canvasaio.assignment.AssignmentGroup` or int
    ...
    def get_assignment_groups(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.assignment.AssignmentGroup`
        """
        from canvasaio.assignment import AssignmentGroup
    ...
    async def get_blueprint(self, template="default", **kwargs):
        ...
        :type template: int or :class:`canvasaio.blueprint.BlueprintTemplate`

        :rtype: :class:`canvasaio.blueprint.BlueprintTemplate`
        """
    ...
    def get_collaborations(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.collaboration.Collaboration`
        """
        return PaginatedList(
            Collaboration,
            self._requester,
    ...
    def get_custom_columns(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.custom_gradebook_columns.CustomGradebookColumn`
        """
        return PaginatedList(
    ...
    async def get_discussion_topic(self, topic, **kwargs):
        ...
        :type topic: :class:`canvasaio.discussion_topic.DiscussionTopic` or int
    ...
    def get_discussion_topics(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.discussion_topic.DiscussionTopic`
        """
        return PaginatedList(
            DiscussionTopic,
            self._requester,
    ...
    async def get_epub_export(self, epub, **kwargs):
        ...
        :type epub: int or :class:`canvasaio.course_epub_export.CourseEpubExport`
    ...
    def get_external_feeds(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.external_feed.ExternalFeed`
        """
        from canvasaio.external_feed import ExternalFeed
    ...
    async def get_external_tool(self, tool, **kwargs):
        ...
        :type tool: :class:`canvasaio.external_tool.ExternalTool` or int
    ...
    def get_external_tools(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.external_tool.ExternalTool`
        """
        from canvasaio.external_tool import ExternalTool
    ...
    def get_gradebook_history_dates(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.grading_history.Day`
        """
    ...
    def get_gradebook_history_details(self, date, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.gradebook_history.Grader`
        """
    ...
    def get_grading_periods(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.grading_period.GradingPeriod`
        """
    ...
    def get_grading_standards(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.grading_standards.GradingStandard`
        """
        return PaginatedList(
            GradingStandard,
            self._requester,
    ...
    def get_group_categories(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.group.GroupCategory`
        """
        from canvasaio.group import GroupCategory
    ...
    async def get_module(self, module, **kwargs):
        ...
        :type module: :class:`canvasaio.module.Module` or int
    ...
    async def get_outcome_group(self, group, **kwargs):
        ...
        :type group: :class:`canvasaio.outcome.OutcomeGroup` or int
    ...
    def get_outcome_groups_in_context(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.outcome.OutcomeGroups`
        """
        from canvasaio.outcome import OutcomeGroup
    ...
    async def get_outcome_import_status(self, outcome_import, **kwargs):
        ...
        :type outcome_import: :class:`canvasaio.outcome_import.OutcomeImport`,
            int, or string: "latest"

        :rtype: :class:`canvasaio.outcome_import.OutcomeImport`
        """
    ...
    async def get_quiz(self, quiz, **kwargs):
        ...
        :type quiz: :class:`canvasaio.quiz.Quiz` or int
    ...
    def get_quiz_overrides(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.quiz.QuizAssignmentOverrideSet`
        """
        from canvasaio.quiz import QuizAssignmentOverrideSet
    ...
    async def get_section(self, section, **kwargs):
        ...
        :type section: :class:`canvasaio.section.Section` or int
    ...
    def get_sections(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.section.Section`
        """
        from canvasaio.section import Section
    ...
    def get_submission_history(self, date, grader_id, assignment_id, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.gradebook_history.SubmissionHistory`
        """
    ...
    def get_uncollated_submissions(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.gradebook_history.SubmissionVersion`
        """
    ...
    def list_blueprint_subscriptions(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.blueprint.BlueprintSubscription`
        """
