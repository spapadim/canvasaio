...
from canvasaio.util import combine_kwargs, is_multivalued, obj_or_id
...
class Group(CanvasObject):
    ...
    def get_memberships(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.group.GroupMembership`
        """
        return PaginatedList(
            GroupMembership,
            self._requester,
    ...
    def get_page(self, url, **kwargs):
        ...
        :rtype: :class:`canvasaio.groups.Group`
        """
        from canvasaio.course import Page
...
class GroupCategory(CanvasObject):
    ...
    def assign_members(self, sync=False, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of :class:`canvasaio.user.User`
            or :class:`canvasaio.progress.Progress`
        """
        from canvasaio.user import User
