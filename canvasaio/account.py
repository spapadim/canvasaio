...
from canvasaio.util import combine_kwargs, file_or_path, obj_or_id, obj_or_str
...
class Account(CanvasObject):
    ...
    def activate_role(self, role, **kwargs):
        ...
        :type role: :class:`canvasaio.account.Role` or int
    ...
    def close_notification_for_user(self, user, notification, **kwargs):
        ...
        :type notification: :class:`canvasaio.account.AccountNotification` or int
    ...
    def create_admin(self, user, **kwargs):
        ...
        :rtype: :class:`canvasaio.account.Admin`
        """
        from canvasaio.user import User
    ...
    def delete_grading_period(self, grading_period, **kwargs):
        ...
        :type grading_period: :class:`canvasaio.grading_period.GradingPeriod` or int
    ...
    def get_admins(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of :class:`canvasaio.account.Admin`
        """
    ...
    def get_authentication_provider(self, authentication_provider, **kwargs):
        ...
        :type authentication_provider:
            :class:`canvasaio.authentication_provider.AuthenticationProvider` or int
    ...
    def get_authentication_providers(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.authentication_provider.AuthenticationProvider`
        """
        from canvasaio.authentication_provider import AuthenticationProvider
    ...
    def get_content_migration(self, content_migration, **kwargs):
        ...
        :type contnet_migration: int, str or :class:`canvasaio.content_migration.ContentMigration`
    ...
    def get_enrollment(self, enrollment, **kwargs):
        ...
        :type enrollment: :class:`canvasaio.enrollment.Enrollment` or int
    ...
    def get_enrollment_term(self, term, **kwargs):
        ...
        :type term: :class:`canvasaio.enrollment_term.EnrollmentTerm` or int
    ...
    def get_enrollment_terms(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.enrollment_term.EnrollmentTerm`
        """
        from canvasaio.enrollment_term import EnrollmentTerm
    ...
    def get_index_of_reports(self, report_type, **kwargs):
        ...
        :type report_type: str
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.account.AccountReport`
        """
        return PaginatedList(
            AccountReport,
            self._requester,
    ...
    def get_scopes(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of :class:`canvasaio.scope.Scope`
        """
    ...
    def get_sis_import(self, sis_import, **kwargs):
        ...
        :type sis_import: int, str or :class:`canvasaio.sis_import.SisImport`
    ...
    def get_sis_imports(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.sis_import.SisImport`
        """
    ...
    def get_sis_imports_running(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList`
            of :class:`canvasaio.sis_import.SisImport`
        """
    ...
    def get_subaccounts(self, recursive=False, **kwargs):
        ...
        :type recursive: bool
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.account.Account`
        """
    ...
    def get_user_notifications(self, user, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.account.AccountNotification`
        """
        from canvasaio.user import User
    ...
    def get_users(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of :class:`canvasaio.user.User`
        """
        from canvasaio.user import User
