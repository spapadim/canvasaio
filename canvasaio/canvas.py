...
from canvasaio.current_user import CurrentUser
...
class Canvas(object):
    ...
    async def create_conversation(self, recipients, body, **kwargs):
        ...
        :type body: `str`
        :rtype: list of :class:`canvasaio.conversation.Conversation`
        """
    ...
    async def create_planner_override(self, plannable_type, plannable_id, **kwargs):
        ...
        :type plannable_id: int or :class:`canvasaio.planner.PlannerOverride`

        :rtype: :class:`canvasaio.planner.PlannerOverride`
        """
        from canvasaio.planner import PlannerOverride
    ...
    async def create_poll(self, poll, **kwargs):
        ...
        :rtype: :class:`canvasaio.poll.Poll`
        """
    ...
    async def get_account(self, account, use_sis_id=False, **kwargs):
        ...
        :type account: int, str or :class:`canvasaio.account.Account`
    ...
    async def get_appointment_group(self, appointment_group, **kwargs):
        ...
        :type appointment_group: :class:`canvasaio.appointment_group.AppointmentGroup` or int
    ...
    def get_appointment_groups(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.appointment_group.AppointmentGroup`
        """
        from canvasaio.appointment_group import AppointmentGroup
    ...
    async def get_calendar_event(self, calendar_event, **kwargs):
        ...
        :type calendar_event: :class:`canvasaio.calendar_event.CalendarEvent` or int
    ...
    def get_comm_messages(self, user, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.comm_message.CommMessage`
    ...
    async def get_conversation(self, conversation, **kwargs):
        ...
        :type conversation: :class:`canvasaio.conversation.Conversation` or int

        :rtype: :class:`canvasaio.conversation.Conversation`
        """
        from canvasaio.conversation import Conversation
    ...
    def get_conversations(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of \
        :class:`canvasaio.conversation.Conversation`
        """
        from canvasaio.conversation import Conversation
    ...
    async def get_course(self, course, use_sis_id=False, **kwargs):
        ...
        :type course: int, str or :class:`canvasaio.course.Course`
    ...
    def get_course_nicknames(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.course.CourseNickname`
        """
        from canvasaio.course import CourseNickname
    ...
    def get_epub_exports(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.course_epub_export.CourseEpubExport`
        """
    ...
    async def get_group_category(self, category, **kwargs):
        ...
        :type category: :class:`canvasaio.group.GroupCategory` or int
    ...
    async def get_planner_note(self, planner_note, **kwargs):
        ...
        :type planner_note: int or :class:`canvasaio.planner.PlannerNote`
    ...
    def get_planner_notes(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.planner.PlannerNote`
        """
        from canvasaio.planner import PlannerNote
    ...
    async def get_planner_override(self, planner_override, **kwargs):
        ...
        :type planner_override: int or :class:`canvasaio.planner.PlannerOverride`
    ...
    def get_planner_overrides(self, **kwargs):
        ...
        :rtype: :class:`canvasaio.paginated_list.PaginatedList` of
            :class:`canvasaio.planner.PlannerOverride`
        """
        from canvasaio.planner import PlannerOverride
    ...
    async def get_progress(self, progress, **kwargs):
        ...
        :type progress: int, str or :class:`canvasaio.progress.Progress`
